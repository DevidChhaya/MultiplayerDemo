...
public class CameraController : MonoBehaviour
{
    ...
    private bool isInteractingWithUI = false; // Flag for UI interaction
    ...
    /// <summary>
    /// Toggles the cursor state based on UI interaction.
    /// </summary>
    /// <param name="interacting">Whether the player is interacting with the UI.</param>
    public void SetUIInteraction(bool interacting)
    {
    ...
    /// <summary>
    /// Updates the cursor state based on UI interaction or camera control.
    /// </summary>
    private void UpdateCursorState()
    {
        if (isInteractingWithUI || clickToMoveCamera)
        {
